...
public class Main {
    public static void main(String args[]) {
        ...
        if (!two.queens(sum1, sum2)) {
            ...
            System.out.println("3     лабораторная    работа = " + three.delat("3     лабораторная    работа"));
            System.out.println("Объектноно -    ориентированно   программирование = " + three.delat("Объектноно -    ориентированно   программирование"));
